...
/**
 * main loop of the application - keeps running until window is closed
 */
...
/**
 * cleans up all initialized objects before ending the program
 */
...
bool Application::isDeviceSuitable(VkPhysicalDevice device) {
	...
	// important to fill to match specific needs in a real project
...
void Application::createGraphicsPipeline() {
	...
	rasterizer.depthBiasEnable = 0.0f; // Optional
